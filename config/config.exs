...
config :circularly, CircularlyWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: CircularlyWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Circularly.PubSub,
  live_view: [signing_salt: "fGYv7JKH"]
...
config :circularly, CircularlyWeb.Gettext, default_locale: "de"
